...
let referralWithdrawalEnabled = false;
...
function renderPayout(payout) {
  ...
  if (!payout) {
    ...
    setWithdrawState(
      ...
      !referralWithdrawalEnabled

        ? "Referral withdrawals are temporarily unavailable."
...
async function withdrawRewards() {
  ...
  if (!referralWithdrawalEnabled) {

    setWithdrawState("Referral withdrawals are temporarily unavailable.", true);
