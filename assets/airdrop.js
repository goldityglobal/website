  ...
  try {
    ...
    if (!res.ok || !data.ok) {
      const messages = {
        ...
        wallet_not_eligible: "This wallet isn't eligible. To claim, your wallet must hold at least about $1 on BNB Smart Chain - for example 1 USDT/USDC or 0.001 BNB.",
